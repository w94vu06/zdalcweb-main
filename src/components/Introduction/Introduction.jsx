      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            <div className="flex flex-col items-center justify-center border border-yellow-600 gap-4 rounded-full w-48">
              <div data-aos="fade-up" className="flex items-center justify-between">
                <p className="text-yellow-600">了解更多</p>
                <GrFormNextLink className="text-4xl h-12 w-12 p-4 dark:bg-violet-400 text-yellow-600" />
              </div>
            </div>
          </div>
        </div>
